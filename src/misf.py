...
class MISF():
    ...
    def metric(self, gt, pre):
        ...
        #ssim = compare_ssim(gt, pre, multichannel=True, data_range=255,win_size=min(gt.shape[0],gt.shape[1],7))
        
        # ssim = compare_ssim(gt, pre, multichannel=True, data_range=255, win_size=None, full=True, use_sample_covariance=False)
